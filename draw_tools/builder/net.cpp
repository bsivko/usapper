...
void
net_t::drawer_t::draw_number( const field::element_t & element, int number ) {
...
void
net_t::drawer_t::draw_unknown( const field::element_t & element ) {
...
void
net_t::drawer_t::draw_flag( const field::element_t & element ) {
...
void
net_t::drawer_t::draw_explode_bomb( const field::element_t & element ) {
...
void
net_t::drawer_t::draw_flag_error( const field::element_t & element ) {
    draw_flag( element );

...
void
fiveangle_t::drawer_t::draw_number(
    ...
    draw_fiveangle( m_canvas, element );
...
void
fiveangle_t::drawer_t::draw_unknown( const field::element_t & element ) {
...
void
fiveangle_t::drawer_t::draw_flag( const field::element_t & element ) {
...
void
fiveangle_t::drawer_t::draw_explode_bomb( const field::element_t & element ) {
...
void
fiveangle_t::drawer_t::draw_link(
...
void
fiveangle_t::drawer_t::draw_flag_error( const field::element_t & element ) {
    draw_flag( element );

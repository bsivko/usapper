#if !defined(_DRAW_TOOL__BUILDER__NET_HPP__INCLUDED_)
#define _DRAW_TOOL__BUILDER__NET_HPP__INCLUDED_
...
//! Инструмента для рисования в C++ Builder, произвольная сеть.
class net_t : public abstract_t {
